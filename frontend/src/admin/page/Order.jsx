                                    ...
                                    <div className="overflow-x-auto">
                                        <table className="min-w-full divide-y divide-gray-200 text-slate-500">
                                            ...
                                            <tr>
                                                ...
                                                <th className="px-6 py-3 text-left font-medium text-gray-700">CreateAt</th>
                                                <th className="px-6 py-3 text-left font-medium text-gray-700">DeliveryAt</th>
                                                <th className="px-6 py-3 text-left font-medium text-gray-700">StatusPay</th>
                                                <th className="px-6 py-3 text-left font-medium text-gray-700">TotalPrice</th>
                                            ...
                                            {orders.length === 0 ? (
                                                ...
                                                orders.map(order => (
                                                    <tr key={order.id}>
                                                        ...
                                                        <td className="px-6 py-4 whitespace-nowrap">{order.createAt}</td>
                                                        <td className="px-6 py-4 whitespace-nowrap">{order.deliveryAt}</td>
                                                        <td className="px-6 py-4 whitespace-nowrap">{order.statusPay}</td>
